                ...
                <table id="alternativePagination" class="display" style="width:100%">
                    <thead>
                        <tr class="text-slate-500 dark:text-zink-200">
                            ...
                            <th class="px-3.5 py-2.5 font-semibold border-b">Quick Pay</th>
                            <th class="px-3.5 py-2.5 font-semibold border-b">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-b border-slate-200 dark:border-zink-500">
                            ...
                            <td class="px-3.5 py-2.5">
                                <div class="flex gap-2">
                                    <a href="#!" data-modal-target="editEmployeeModal" id="updateRecord" class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 bg-slate-100 dark:bg-zink-600 dark:text-zink-200 text-slate-500 hover:text-custom-500 dark:hover:text-custom-500 hover:bg-custom-100 dark:hover:bg-custom-500/20"><i data-lucide="pencil" class="size-4"></i></a>
